...
public class Character : MonoBehaviour {
	...
	void Update () {
        if (Input.GetKey(KeyCode.LeftArrow) && transform.rotation.z != 270)
        {
            transform.rotation = Quaternion.Euler(0, 0, 270);
        }
        else if (Input.GetKey(KeyCode.RightArrow) && transform.rotation.z != 90)
        {
            transform.rotation = Quaternion.Euler(0, 0, 90);
        }
        else if (Input.GetKey(KeyCode.DownArrow) && transform.rotation.z != 0)
        {
